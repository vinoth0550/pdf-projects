...
# temp1.py -template 1 without banner section and added job role section
...
TEMPLATES = {
    "Classic Black": {
        ...
        "font_sizes": {"title": 18, "job_role": 16, "header": 12, "body": 11},   # 18  16   12

        "spacing": {"section": 10, "paragraph": 4}                               # 10  4
    }
}
    ...
    def draw_content(y_position, sidebar_data, main_data, start_sidebar_idx=0, start_main_idx=0, start_sidebar_line=0, start_main_line=0):
        ...
        if start_sidebar_idx == 0 and start_main_idx == 0:
            ...
            if data.get("job_role"):
                ...
                main_y -= (job_role_size + section_gap + 5)  
            else:
                main_y -= section_gap  
