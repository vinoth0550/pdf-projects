...
# temp3.py -template 3 without banner section and added job role section
...
TEMPLATES ={
    ...
    "Creative Teal": {
        ...
        "sidebar_width": 0.32,  # old one is 0.22
        "font_name": "Arial",
        "font_name_bold": "Arial-Bold",
        "font_sizes": {"title": 18,  "job_role": 16, "header": 12, "body": 11}, # title-20, job role-16, header-13, body-11.
        "spacing": {"section": 13, "paragraph": 8} # 16    6
    ...
    def draw_content(y_position, sidebar_data, main_data, start_sidebar_idx=0, start_main_idx=0, start_sidebar_line=0, start_main_line=0):
        ...
        if start_sidebar_idx == 0 and start_main_idx == 0:
            ...
            if data.get("job_role"):
                ...
                c.setFillColor(colors.HexColor("#12A89D"))# White text for contrast
