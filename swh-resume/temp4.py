...
# temp4.py -template 4 without banner section and added job role section
...
TEMPLATES = {
    "Professional Blue": {
        "primary": colors.HexColor("#2C4850"),       #2C3E50
        "secondary": colors.HexColor("#3498DB"),
        "text": colors.black,
        "sidebar_bg": colors.HexColor( "#BEA47D"),    #F5F5F5
        "sidebar_width": 0.30, # 25
        "font_name": "Calibri",
        "font_name_bold": "Calibri-Bold",
        "font_sizes": {"title": 22, "job_role": 18, "header": 12, "body": 11},  # 18  16  12  11
        "spacing": {"section": 12, "paragraph": 4}                              # 12  4
...
#
    ...
    def draw_content(y_position, sidebar_data, main_data, start_sidebar_idx=0, start_main_idx=0, start_sidebar_line=0, start_main_line=0):
        ...
        if start_sidebar_idx == 0 and start_main_idx == 0:
            ...
            if data.get("job_role"):
                ...
                c.setFillColor(colors.HexColor("#2C3E50"))# White text for contrast
    ...
    #         c.drawImage(img, x, y, width=scaled_w, height=scaled_h, mask='auto')
    #         banner_drawn_height = scaled_h
    #     except Exception:
    #         banner_drawn_height = 0
...
###
    ...
    try:
        ...
        style = TEMPLATES['Professional Blue']
